...
# ... Continuing Level 3
level_3.extend([
    {"title": "Tổng số chẵn", "description": "Tính tổng các số chẵn từ 1 đến N.\n\n**Input:**\n- Số nguyên N\n\n**Output:**\n- Tổng các số chẵn", "difficulty": "Easy", "test_cases": [{"input": "5", "output": "6"}, {"input": "1", "output": "0"}, {"input": "10", "output": "30"}, {"input": "2", "output": "2"}, {"input": "6", "output": "12"}], "hint": "Loop if i%2==0"},
    {"title": "Số nguyên tố", "description": "Kiểm tra N có phải số nguyên tố hay không.\n\n**Input:**\n- Số nguyên N\n\n**Output:**\n- In \"Yes\" nếu là số nguyên tố, ngược lại \"No\"", "difficulty": "Medium", "test_cases": [{"input": "7", "output": "Yes"}, {"input": "4", "output": "No"}, {"input": "1", "output": "No"}, {"input": "2", "output": "Yes"}, {"input": "13", "output": "Yes"}], "hint": "Loop 2 to sqrt(n)"},
    {"title": "Tổng chữ số", "description": "Nhập N. Tính tổng các chữ số của N.\n\n**Input:**\n- Số nguyên N\n\n**Output:**\n- Tổng các chữ số", "difficulty": "Medium", "test_cases": [{"input": "123", "output": "6"}, {"input": "0", "output": "0"}, {"input": "12345", "output": "15"}, {"input": "10", "output": "1"}, {"input": "999", "output": "27"}], "hint": "While n>0: sum += n%10; n/=10"},
    {"title": "Số đảo ngược", "description": "Nhập N. In ra số đảo ngược của N.\n\n**Input:**\n- Số nguyên N\n\n**Output:**\n- Số đảo ngược", "difficulty": "Medium", "test_cases": [{"input": "123", "output": "321"}, {"input": "505", "output": "505"}, {"input": "9", "output": "9"}, {"input": "121", "output": "121"}, {"input": "1203", "output": "3021"}], "hint": "While..."},
    {"title": "Dãy Fibonacci", "description": "In N số Fibonacci đầu tiên bắt đầu từ 0 và 1.\n\n**Input:**\n- Số nguyên N\n\n**Output:**\n- N số Fibonacci cách nhau bởi khoảng trắng", "difficulty": "Medium", "test_cases": [{"input": "5", "output": "0 1 1 2 3"}, {"input": "1", "output": "0"}, {"input": "2", "output": "0 1"}, {"input": "3", "output": "0 1 1"}, {"input": "4", "output": "0 1 1 2"}], "hint": "Loop"}
])

# --- Level 4: Mảng (Arrays) ---
level_4 = [
    {"title": "Nhập xuất mảng", "description": "Nhập N và mảng N phần tử. In các phần tử của mảng ra trên một dòng.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Dòng 2: N số nguyên cách nhau bởi khoảng trắng\n\n**Output:**\n- N số nguyên đã nhập", "difficulty": "Easy", "test_cases": [{"input": "3\n1 2 3", "output": "1 2 3"}, {"input": "1\n10", "output": "10"}, {"input": "5\n1 2 3 4 5", "output": "1 2 3 4 5"}, {"input": "2\n5 6", "output": "5 6"}, {"input": "4\n1 1 1 1", "output": "1 1 1 1"}], "hint": "Array/List"},
    {"title": "Tổng mảng", "description": "Nhập N và mảng A. Tính tổng các phần tử trong mảng.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Dòng 2: N số nguyên\n\n**Output:**\n- Tổng các phần tử", "difficulty": "Easy", "test_cases": [{"input": "3\n1 2 3", "output": "6"}, {"input": "1\n99", "output": "99"}, {"input": "5\n1 1 1 1 1", "output": "5"}, {"input": "2\n10 20", "output": "30"}, {"input": "4\n1 2 3 4", "output": "10"}], "hint": "Sum loop"},
    {"title": "Max min mảng", "description": "Tìm giá trị lớn nhất (max) và nhỏ nhất (min) trong mảng.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Dòng 2: N số nguyên\n\n**Output:**\n- Hai số Max và Min cách nhau bởi khoảng trắng", "difficulty": "Easy", "test_cases": [{"input": "3\n1 5 2", "output": "5 1"}, {"input": "1\n7", "output": "7 7"}, {"input": "4\n-1 -5 0 2", "output": "2 -5"}, {"input": "2\n-1 -1", "output": "-1 -1"}, {"input": "5\n1 2 3 4 5", "output": "5 1"}], "hint": "Compare loop"},
    {"title": "Đếm số chẵn mảng", "description": "Đếm số lượng các số chẵn có trong mảng.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Dòng 2: N số nguyên\n\n**Output:**\n- Số lượng số chẵn", "difficulty": "Medium", "test_cases": [{"input": "4\n1 2 3 4", "output": "2"}, {"input": "3\n1 3 5", "output": "0"}, {"input": "5\n2 4 6 8 0", "output": "5"}, {"input": "1\n1", "output": "0"}, {"input": "2\n2 3", "output": "1"}], "hint": "Count if"},
    {"title": "Tìm k trong mảng", "description": "Nhập N, mảng A và số k. Tìm vị trí đầu tiên của k trong mảng (vị trí tính từ 1). Nếu không có in -1.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Dòng 2: N số nguyên\n- Dòng 3: Số nguyên k cần tìm\n\n**Output:**\n- Vị trí tìm thấy hoặc -1", "difficulty": "Medium", "test_cases": [{"input": "3\n1 5 2\n5", "output": "2"}, {"input": "4\n1 2 3 4\n5", "output": "-1"}, {"input": "3\n5 5 5\n5", "output": "1"}, {"input": "2\n1 2\n3", "output": "-1"}, {"input": "5\n1 2 3 4 5\n3", "output": "3"}], "hint": "Linear search (-1 if not found)"},
    {"title": "Mảng đảo ngược", "description": "Nhập mảng N phần tử và in ra theo thứ tự ngược lại.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Dòng 2: N số nguyên\n\n**Output:**\n- Mảng đảo ngược", "difficulty": "Easy", "test_cases": [{"input": "3\n1 2 3", "output": "3 2 1"}, {"input": "1\n5", "output": "5"}, {"input": "4\n1 3 3 7", "output": "7 3 3 1"}, {"input": "2\n1 2", "output": "2 1"}, {"input": "5\n1 2 3 4 5", "output": "5 4 3 2 1"}], "hint": "Loop N-1 to 0"},
    {"title": "Sắp xếp tăng dần", "description": "Sắp xếp các phần tử trong mảng theo thứ tự tăng dần.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Dòng 2: N số nguyên\n\n**Output:**\n- Mảng đã sắp xếp", "difficulty": "Medium", "test_cases": [{"input": "3\n3 1 2", "output": "1 2 3"}, {"input": "1\n10", "output": "10"}, {"input": "5\n5 4 3 2 1", "output": "1 2 3 4 5"}, {"input": "2\n2 1", "output": "1 2"}, {"input": "4\n4 3 2 1", "output": "1 2 3 4"}], "hint": "Bubble sort / built-in sort"},
    {"title": "Trung bình cộng mảng", "description": "Tính trung bình cộng các giá trị trong mảng.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Dòng 2: N số nguyên\n\n**Output:**\n- Trung bình cộng (lấy 2 chữ số thập phân)", "difficulty": "Medium", "test_cases": [{"input": "3\n1 2 4", "output": "2.33"}, {"input": "1\n1", "output": "1.00"}, {"input": "4\n2 2 3 3", "output": "2.50"}, {"input": "2\n1 1", "output": "1.00"}, {"input": "5\n1 2 3 4 5", "output": "3.00"}], "hint": "Sum / N"},
    {"title": "Số lớn thứ 2", "description": "Tìm số lớn thứ 2 trong mảng.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Dòng 2: N số nguyên\n\n**Output:**\n- Số lớn thứ 2", "difficulty": "Medium", "test_cases": [{"input": "4\n1 5 2 5", "output": "2"}, {"input": "3\n10 10 10", "output": "10"}, {"input": "5\n1 2 3 4 5", "output": "4"}, {"input": "2\n1 2", "output": "1"}, {"input": "4\n1 1 2 2", "output": "1"}], "hint": "Sort or scan"}, 
    {"title": "Chèn phần tử", "description": "Chèn một giá trị x vào vị trí k trong mảng.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Dòng 2: N số nguyên\n- Dòng 3: Giá trị x và vị trí k (cách nhau bởi khoảng trắng)\n\n**Output:**\n- Mảng sau khi chèn", "difficulty": "Hard", "test_cases": [{"input": "3\n1 2 3\n5 1", "output": "1 5 2 3"}, {"input": "2\n1 2\n10 0", "output": "10 1 2"}, {"input": "3\n1 2 3\n9 3", "output": "1 2 3 9"}, {"input": "1\n1\n5 0", "output": "5 1"}, {"input": "2\n1 2\n7 2", "output": "1 2 7"}], "hint": "Array shift"}
]

# --- Level 5: Nâng cao ---
level_5 = [
    {"title": "UCLN và BCNN", "description": "Tìm ước chung lớn nhất (UCLN) và bội chung nhỏ nhất (BCNN) của 2 số nguyên dương.\n\n**Input:**\n- Hai số nguyên dương a, b cách nhau bởi khoảng trắng\n\n**Output:**\n- UCLN và BCNN cách nhau bởi khoảng trắng", "difficulty": "Medium", "test_cases": [{"input": "2 4", "output": "2 4"}, {"input": "5 10", "output": "5 10"}, {"input": "7 13", "output": "1 91"}, {"input": "12 18", "output": "6 36"}, {"input": "10 25", "output": "5 50"}], "hint": "GCD Alg"},
    {"title": "Kiểm tra đối xứng", "description": "Kiểm tra xem một chuỗi hoặc một số nhập vào có phải là đối xứng (Palindrome) hay không.\n\n**Input:**\n- Một chuỗi k tự hoặc chữ số\n\n**Output:**\n- In \"Yes\" nếu đối xứng, ngược lại \"No\"", "difficulty": "Medium", "test_cases": [{"input": "madam", "output": "Yes"}, {"input": "a", "output": "Yes"}, {"input": "1221", "output": "Yes"}, {"input": "racecar", "output": "Yes"}, {"input": "aba", "output": "Yes"}], "hint": "Check ends"},
    {"title": "Tháp hình sao", "description": "Vẽ tam giác sao cân đối xứng có chiều cao h.\n\n**Input:**\n- Số nguyên h\n\n**Output:**\n- Tam giác sao với chiều cao h", "difficulty": "Hard", "test_cases": [{"input": "3", "output": "  *\n ***\n*****"}, {"input": "1", "output": "*"}, {"input": "2", "output": " *\n***"}, {"input": "4", "output": "   *\n  ***\n *****\n*******"}, {"input": "5", "output": "    *\n   ***\n  *****\n *******\n*********"}], "hint": "Nested loops space/star"},
    {"title": "Ma trận chuyển vị", "description": "Nhập ma trận kích thước NxM. In ra ma trận chuyển vị MxN tương ứng.\n\n**Input:**\n- Dòng 1: Hai số N và M\n- Các dòng tiếp theo: Ma trận NxM\n\n**Output:**\n- Ma trận chuyển vị MxN", "difficulty": "Hard", "test_cases": [{"input": "2 2\n1 2\n3 4", "output": "1 3\n2 4"}, {"input": "1 1\n5", "output": "5"}, {"input": "2 3\n1 2 3\n4 5 6", "output": "1 4\n2 5\n3 6"}, {"input": "3 1\n1\n2\n3", "output": "1 2 3\n"}, {"input": "1 3\n1 2 3", "output": "1\n2\n3\n"}], "hint": "Matrix logic"},
    {"title": "Tính tổ hợp chập k của n", "description": "Tính giá trị của tổ hợp chập k của n (nCk).\n\n**Input:**\n- Hai số nguyên n và k\n\n**Output:**\n- Giá trị tổ hợp", "difficulty": "Medium", "test_cases": [{"input": "5 2", "output": "10"}, {"input": "5 1", "output": "5"}, {"input": "5 0", "output": "1"}, {"input": "5 5", "output": "1"}, {"input": "10 2", "output": "45"}], "hint": "Recursion or formula"},
    {"title": "Liệt kê số nguyên tố < N", "description": "Liệt kê tất cả các số nguyên tố nhỏ hơn N.\n\n**Input:**\n- Số nguyên N\n\n**Output:**\n- Các số nguyên tố cách nhau bởi khoảng trắng", "difficulty": "Hard", "test_cases": [{"input": "10", "output": "2 3 5 7"}, {"input": "2", "output": ""}, {"input": "5", "output": "2 3"}, {"input": "3", "output": "2"}, {"input": "20", "output": "2 3 5 7 11 13 17 19"}], "hint": "Sieve"},
    {"title": "Chuyển nhị phân", "description": "Chuyển đổi một số nguyên dương từ hệ thập phân sang hệ nhị phân.\n\n**Input:**\n- Số nguyên dương N\n\n**Output:**\n- Chuỗi nhị phân tương ứng", "difficulty": "Medium", "test_cases": [{"input": "5", "output": "101"}, {"input": "0", "output": "0"}, {"input": "10", "output": "1010"}, {"input": "1", "output": "1"}, {"input": "8", "output": "1000"}], "hint": "Div mod 2"},
    {"title": "Đếm từ trong chuỗi", "description": "Đếm số lượng từ có trong một chuỗi ký tự nhập vào.\n\n**Input:**\n- Một dòng văn bản\n\n**Output:**\n- Số lượng từ", "difficulty": "Medium", "test_cases": [{"input": "Hello World", "output": "2"}, {"input": "  ", "output": "0"}, {"input": "A B C", "output": "3"}, {"input": "A", "output": "1"}, {"input": "One Two Three Four", "output": "4"}], "hint": "Split space"},
    {"title": "Tổng đường chéo chính", "description": "Tính tổng các phần tử trên đường chéo chính của một ma trận vuông kích thước NxN.\n\n**Input:**\n- Dòng 1: Số nguyên N\n- Các dòng tiếp theo: Ma trận vuông NxN\n\n**Output:**\n- Tổng đường chéo chính", "difficulty": "Medium", "test_cases": [{"input": "2\n1 2\n3 4", "output": "5"}, {"input": "1\n5", "output": "5"}, {"input": "3\n1 0 0\n0 1 0\n0 0 1", "output": "3"}, {"input": "2\n0 0\n0 0", "output": "0"}, {"input": "2\n1 1\n1 1", "output": "2"}], "hint": "Loop i,i"},
    {"title": "Sắp xếp tên", "description": "Nhập danh sách N tên người và sắp xếp chúng theo thứ tự bảng chữ cái (A-Z).\n\n**Input:**\n- Dòng 1: Số nguyên N\n- N dòng tiếp theo: Mỗi dòng là 1 tên\n\n**Output:**\n- Danh sách tên đã sắp xếp", "difficulty": "Hard", "test_cases": [{"input": "2\nB\nA", "output": "A\nB"}, {"input": "1\nZ", "output": "Z"}, {"input": "3\nC\nB\nA", "output": "A\nB\nC"}, {"input": "2\nJohn\nAlice", "output": "Alice\nJohn"}, {"input": "3\nCat\nDog\nBat", "output": "Bat\nCat\nDog"}], "hint": "String compare"}
]
...
def process_level(level_list, category_name):
    for p in level_list:
        ...
        # 0. Enrich Description with Structured Formatting
        # We assume the description currently contains sections like **Input:** and **Output:**
        # We will reformat these to ### headers for better look in web UI.
        desc = p["description"]
        
        # Standardize sections to bold text (marked will handle headers if we use #)
        desc = desc.replace("**Input:**", "### Dữ liệu vào").replace("**Output:**", "### Kết quả ra")
        
        # Add Example section
        if p["test_cases"]:
            first_tc = p["test_cases"][0]
            example_md = f"\n\n### Ví dụ:\n**Đầu vào:**\n<div class='example-box'>{first_tc['input']}</div>\n**Đầu ra:**\n<div class='example-box'>{first_tc['output']}</div>"
            desc = desc + example_md
